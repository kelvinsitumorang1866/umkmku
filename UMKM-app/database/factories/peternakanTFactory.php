...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\peternakanT>
 */
class peternakanTFactory extends Factory
{
    /**
     ...
     */
    protected $model = peternakanT::class;
    public function definition(): array
    {
        ...
        return [
        'Umkm_id' => 3, // Assuming Umkm_id is always 1 for all records
